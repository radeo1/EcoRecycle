...
public class Vending extends JFrame {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            try{
                ...
                if (change >= 0.0) {
                    ...
                    outputChangeTF.setText("Your total is: " + change);
                }
                else
    ...
    final String[] goodyNames = { "Paper", "Plastic containers", "Glass Containers", "Cartons", "Scrap Metals" };
    final String[] goodyTips = {
    		"Paper", "Plastic containers", "Glass Containers", "Cartons", "Scrap Metals"
    };
    ...
    public Vending(String s) {
        ...
        for (int i = 0; i < goodyType; i++) {
			...
			{
				case("0"):
					goodyTextButtons[i].setMnemonic(KeyEvent.VK_0);
					break;
				case("1"):
					goodyTextButtons[i].setMnemonic(KeyEvent.VK_1);
					break;
				case("2"):
					goodyTextButtons[i].setMnemonic(KeyEvent.VK_2);
					break;
				case("3"):
					goodyTextButtons[i].setMnemonic(KeyEvent.VK_3);
					break;
				case("4"):
					goodyTextButtons[i].setMnemonic(KeyEvent.VK_4);
					break;
				default:
					break;
			}
