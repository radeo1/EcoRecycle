...
public class Constant {
	public final static double CAPACITY = 200;
	public final static double CREDIT_CASH = 100;
	public final static double CREDIT_COUPON = 100;
	public final static int MAX_RCM = 10;
	public final static String SUCCESS = "success";
	public final static String ERROR = "error";
	public final static String FILLED75P = "FILLED75P";
	public final static String FILLED100P = "FILLED100P";
	public final static String CASH25P = "CASH25P";
